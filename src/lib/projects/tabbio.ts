...
import TabbioImage from '@/../public/assets/images/projects/tabbio.png';

export const TabbioSmartCv: Project = {
  id: 8,
  title: 'Tabbio Smart CV - Landing Page',
  subtitle: 'Tabbio Smart CV',
  previewTitle: 'Tabbio Smart CV | UI/UX Design',
  description:
  ...
  goals: {
    description:
      'The primary goal of the design for Maxwell EVa Charging was to create a seamless, intuitive, and eco-conscious user experience that removes friction from the EV charging process while promoting sustainable mobility.',
    goalBlocks: [
      {
        keyword: 'Simplify',
