...
import ExpenseMasterImage from '@/../public/assets/images/projects/expense-master.png';

export const KaleriAI: Project = {
  id: 5,
  title: 'ExpenseMaster | UI/UX Design',
  subtitle: 'ExpenseMaster',
  previewTitle: 'ExpenseMaster | UI/UX Design',
