...
import BusBooksImage from '@/../public/assets/images/projects/learn-web.png';

export const BusBooks: Project = {
  id: 1,
  previewTitle: 'BusBooks | UI/UX Design',
  title: 'BusBooks - Landing Page',
  subtitle: 'BusBooks',
  description:
