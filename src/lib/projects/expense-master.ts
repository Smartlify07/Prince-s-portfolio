...
import ExpenseMasterImage from '@/../public/assets/images/projects/saas-web.png';

export const ExpenseMaster: Project = {
  id: 7,
  title: 'Expense Master - Landing Page',
  subtitle: 'Expense Master',
  previewTitle: 'SAAS Web | UI/UX Design',
