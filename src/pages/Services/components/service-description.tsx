...
export const ServiceDescription = () => {
  return (
    <section className="flex flex-col gap-8 bg-[#111119] p-6 rounded-4xl lg:flex-row">
      <div className="flex flex-col gap-4">
        <h1 className="text-[40px] font-medium -tracking-smaller font-geist gradient-text">
          I help clients turn great ideas into Excellent Products
        </h1>
      ...
      <Card className="lg:h-[362px] lg:w-[300px] shrink-0">
