  ...
  return (
    <section>
      <p className="text-sm/[150%] text-grey-9">
        ...
        Privacy Policy. By using the website and/or its services, you agree to
        the terms laid out in this Privacy Policy.
        <br /> <br />
        Interpretation: In this Privacy Policy, references to “You”, “Your”,
        “User” refer to the end user accessing the website or the services and
        “I” “My” “Me” “We”, “Us” and “Our” refer to the Individual, or Company,
        its affiliates and partners.
      </p>
    </section>
  );
};
