...
export const MoralCompasses = () => {
  ...
  return (
    <section className="px-4 lg:px-0 font-geist grid lg:grid-cols-2 gap-6">
      <div className="flex flex-col gap-9 justify-between">
        ...
        <div className="flex items-stretch gap-4 w-full">
          <div className="w-[40%] h-[280px] rounded-2xl object-cover">
            <img
              src={Prince1}
              alt="Prince looking at the camera"
          ...
          <div className="w-[60%] h-[280px] rounded-2xl object-cover">
            <img
              src={Prince2}
              alt="Prince looking at his laptop"
