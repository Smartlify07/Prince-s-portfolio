...
export const NavbarMobile = () => {
  return (
    <nav className="bg-[rgb(14,14,14,0.7)] z-30 fixed w-11/12  justify-center self-center backdrop-blur-2xl bottom-10 flex items-center gap-4 md:hidden rounded-4xl border border-[rgba(76,76,76,0.6)] p-3.5">
