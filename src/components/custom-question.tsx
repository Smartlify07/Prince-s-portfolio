...
export const CustomQuestion = () => {
  return (
    <section className=" lg:px-0 lg:w-4/12 w-full">
        ...
        <Card className="shadow-none rounded-4xl border-t-white-opaque bg-[#171721] border-l-white-opaque grid gap-6 border-b-white p-6">
          ...
          <div className="grid gap-9">
            ...
            <Button
              as="a"
              target="_blank"
              href="mailto:designername@example.com?subject=Project%20Inquiry&body=Hi%20[Designer%20Name],%0A%0AI%20came%20across%20your%20portfolio%20and%20would%20love%20to%20discuss%20a%20potential%20project.%0A%0ACould%20you%20share%20more%20details%20about%20your%20rates%20and%20availability%3F%0A%0AThanks!%0A[Your%20Name]"
              variant="default"
